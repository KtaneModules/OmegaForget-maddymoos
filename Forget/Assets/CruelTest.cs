...
public class CruelTest : MonoBehaviour {
    ...
    IEnumerator OhJesus()
    {
        float tom = 0; while (tom <= .3f)
        {
            Orbs[9].localPosition = Vector3.Lerp(Orbs[9].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[10].localPosition = Vector3.Lerp(Orbs[10].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[11].localPosition = Vector3.Lerp(Orbs[11].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[12].localPosition = Vector3.Lerp(Orbs[12].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[13].localPosition = Vector3.Lerp(Orbs[13].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[14].localPosition = Vector3.Lerp(Orbs[14].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[15].localPosition = Vector3.Lerp(Orbs[15].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            Orbs[16].localPosition = Vector3.Lerp(Orbs[16].localPosition, new Vector3(0f, 0f, 0f), tom * tom * (3.0f - 2.0f * tom));
            yield return new WaitForSeconds(1.5f); tom += .1f;
        }
    }
